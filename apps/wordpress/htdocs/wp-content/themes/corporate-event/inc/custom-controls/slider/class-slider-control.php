...
if ( ! class_exists( 'Corporate_Event_Slider_Control' ) ) {

	/**
	/**
	 * Slider control (range).
	 */
	class Corporate_Event_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'corporate-event-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'corporate-event-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
