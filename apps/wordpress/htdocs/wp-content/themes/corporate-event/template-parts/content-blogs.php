...
<div class="single-post">
    <div class="info">
        <ul class="list-inline">
            ...
            <li><i class="fa fa-comments-o"></i> <?php comments_popup_link( __('zero comment','corporate-event'), __('one comment','corporate-event'), '% '.__('comments','corporate-event') ); ?></li>
        </ul>
    </div>
    ...
    <div class="post-content">
        ...
        <div class="bottom-info">
            <a href="<?php the_permalink(); ?>" rel="bookmark" title="" class="btn btn-primary pull-left"><?php esc_html_e('Read More','corporate-event'); ?> <i class="fa fa-angle-double-right"></i></a>
